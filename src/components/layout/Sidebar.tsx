...
const I = {
  ...
  lamina:  (<svg viewBox="0 0 20 20" fill="none"><rect x="2" y="3" width="16" height="14" rx="1.5" stroke="currentColor" strokeWidth="1.5"/><path d="M6 3v14M10 3v14M14 3v14" stroke="currentColor" strokeWidth="1.2" strokeLinecap="round"/><path d="M2 7h16M2 13h16" stroke="currentColor" strokeWidth="1.2" strokeLinecap="round"/></svg>),
};
...
export const CLIENTE_SECTIONS: NavSection[] = [
  {
    ...
    items: [
      ...
      { label: "Roteiro", href: "/cliente/roteiro", icon: I.roteiro, feature: "roteiro" },
      { label: "Histórico", href: "/cliente/historico", icon: I.clock   },
      { label: "Calendário", href: "/cliente/calendario", icon: I.calendar, feature: "agendamento" },
      { label: "Métricas", href: "/cliente/metricas", icon: I.metrics, feature: "metricas" },
      { label: "Resumo", href: "/cliente/resumo", icon: I.resumo, feature: "resumo" },
...
export const UNIDADE_SECTIONS: NavSection[] = [
  {
    ...
    items: [
      ...
      { label: "Histórico", href: "/unidade/historico", icon: I.clock },
      { label: "Card WhatsApp", href: "/unidade/publicar/cards", icon: I.whatsapp, feature: "card_whatsapp" },
      { label: "Calendário", href: "/unidade/calendario", icon: I.calendar, feature: "agendamento" },
      ...
      { label: "Chat", href: "/unidade/chat", icon: I.chat },
...
export const GERENTE_SECTIONS: NavSection[] = [
  {
    ...
    items: [
      ...
      { label: "Resumo", href: "/gerente/resumo", icon: I.resumo, feature: "resumo" },
...
export const VENDEDOR_SECTIONS: NavSection[] = [
  {
    ...
    items: [
      ...
      { label: "Calendário", href: "/consultor/calendario", icon: I.calendar, feature: "agendamento" },
