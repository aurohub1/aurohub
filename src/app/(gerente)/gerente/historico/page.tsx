...
export default function GerenteHistoricoPage() {
  ...
  const { startTour } = useTour({
    pageKey: "gerente-historico",
    steps: [
      { element: "[data-tour='titulo-historico']", popover: { title: "Histórico de Postagens", description: "Veja todas as publicações feitas pela sua loja, ordenadas da mais recente para a mais antiga." } },
