...
export default function GerentePublicarPage() {
  ...
  // Seletor de tipo (tela inicial). Ativo até escolher um tipo;
  // botão "← Trocar tipo" no form volta pra cá.
  ...
  const loadData = useCallback(async () => {
    try {
      ...
      // system_config.tmpl_* — agrega formTypes disponíveis (licensee do user ou base)
      try {
    ...
    return (
      <PublicarFlow
        ...
        onSelectType={(type) => {
          ...
          // Primeiro formato visível/disponível pro tipo escolhido
