  ...
  return(
    <div style={{display:"flex",flexDirection:"column",height:"100%",overflow:"hidden",transition:"opacity .26s",opacity:animOut?0:1}}>
      ...
      <div style={{display:"flex",flex:1,minHeight:0,overflow:"hidden"}}>
        ...
        {/* FORMULÁRIO — coluna com altura fixa */}
        <div style={{width:"360px",flexShrink:0,background:"var(--bg1)",borderRight:"1px solid var(--bdr)",display:"flex",flexDirection:"column",overflow:"hidden",minHeight:0}}>
          ...
          {/* Pills formato */}
          <div style={{display:"flex",alignItems:"center",gap:"6px",padding:"8px 14px",borderBottom:"1px solid var(--bdr)",flexShrink:0,background:"var(--bg1)"}}>
          ...
          {/* Footer */}
          <div style={{padding:"12px 14px",borderTop:"1px solid var(--bdr)",display:"flex",flexDirection:"column",gap:"6px",flexShrink:0,background:"var(--bg1)"}}>
          ...
          {/* Contadores */}
          <div style={{display:"flex",gap:"16px",padding:"7px 14px",borderTop:"1px solid var(--bdr)",flexShrink:0,background:"var(--bg1)"}}>
