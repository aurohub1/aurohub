...
export default function ConsultorResumoPage() {
  ...
  const { startTour } = useTour({
    ...
    steps: [
      { popover: { title: "Resumo de Publicações", description: "Veja um panorama das suas publicações no período selecionado." } },
      { popover: { title: "Filtros de período", description: "Navegue entre meses e filtre por formato para análises específicas." } },
      { popover: { title: "Gráficos", description: "Acompanhe a distribuição por formato e a evolução das publicações." } },
    ],
    autoStart: true,
    delay: 1000,
  });
